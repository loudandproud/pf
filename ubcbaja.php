<div id="ubcbaja" class="panel" data-number="5">
    ...
    <section class="page-sec cf">
        <div class="page-inner-top">
            ...
            <p class="tools-p">HTML5, CSS3, jQuery, Photoshop, Illustrator</p>
        </div>
    </section>
        ...
        <div class="page-inner">
            ...
            <div class="cf ubc-homewf">
                <ol class="wfdescription ubc-wf">
                    ...
                    <li>2 different sized sponsorship banner advertising<br>&ensp;&ensp;&ensp;&nbsp; spaces on body</li>
    ...
    <section class="page-sec bg2 bg-b">
        ...
        <h2 class="page-h2 ubc-h2">Sponsorship page Wireframe and Feature</h2>
            ...
            <div class="sps-img cf">
                ...
                <img src="img/ubcbaja/sponsorship-after.jpg" alt="ubc-sponsorship-after" class="sps-after">         
            </div>
        </div>
    </section>
    <section class="page-sec cf">
            ...
            <div class="ubc-mobile tip cf" title="Hover <br>The <br>Devices" >
                <div class="page-smartphone">
                    ...
                    <div class="page-smartphone-inner">
                        <img src="img/ubcbaja/ubc-spsr-smartphone2.jpg" alt="ubcbaja-sponsorship-smartphone" class="ubc-spsr-smp">
                    </div>
                </div>
                <div class="page-tablet">
                    <div class="ubc-hover-tablet">Hover the tablet!</div>
                    <div class="page-tablet-inner">
                        <img src="img/ubcbaja/ubc-spsr-tablet.jpg" alt="ubcbaja-sponsorship-tablet" class="ubc-spsr-tbl ubc-offtip">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="page-sec cf tip">
        <div class="page-inner ubc-tstmnl">
            <h2 class="page-h2 ">What they had to say...</h2>
            <div class="tstmnl cf">
                <img src="img/ubcbaja/sean.png" alt="ubc-baja-testmimonial" class="ubc-tstmnl-left">
                <p class="ubc-tstmnl-right">The timelines of Toru's work and innate skill to capture our needs were huge factors to the success of our project. Eager, bright, and organized; I couldn't recommend anyone else!</p>
