<div id="ubcbaja" class="panel" data-number="5">
        ...
        <section class="page-sec cf">
            <div class="page-inner">
                ...
                <div class="ubc-mobile tip cf" title="Hover <br>The <br>Devices" >
                    <div class="page-smartphone" id="offtip1">
                        <div class="page-smartphone-inner">    
                            <img src="img/ubcbaja/ubc-spsr-smartphone.jpg" alt="ubcbaja-sponsorship-smartphone" class="ubc-spsr-smp">
                        </div>
                    </div>
                    <div class="page-tablet" id="offtip2">
        ...
        <section class="page-sec cf tip">
            <div class="page-inner">
                ...
                <div class="tstmnl cf">
                    <img src="img/ubcbaja/sean.png" alt="ubc-baja-testmimonial" class="tstmnl-left">
                    <p class="tstmnl-right">The timelines of Toru's work and innate skill to capture our needs were huge factors to the success of our project. Eager, bright, and organized; I couldn't recommend anyone else!</p>
