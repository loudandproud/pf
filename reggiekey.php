<div id="reggiekey" class="panel" data-number="8">
    ...
    <section class="page-sec">
       <div class="page-inner-top">
            ...
            <p class="description-p">Reggie Key Watson is a professional jazz piano player and we were assigned to update his website to build his personal brand.</p>
        ...
        <div class="page-inner rgk-inner-rc cf">
            <div class="ubc-inner-left">    
                ...
                <ul class="disc-listred rgk-listred">
                    ...
                    <li><span class="listred-inner">Reggie has Twitter and Facebook accounts and they are very active.</span></li>
                </ul>
            </div>
            <div class="ubc-inner-right">    
                <h2 class="page-h2 rgk-h2-list">Requirement</h2>
                <ul class="disc-listblue rgk-listblue">
                    ...
                    <li><span class="listblue-inner">The website should be fun, playful, exciting but at the same time business-like and professional as Reggie does lots of big events such as music festivals, hotel events, private parties, and more.</span></li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section class="page-sec bg2 bg-b">
        <div class="page-inner">
            ...
            <p class="inner-p">To show his live schedule, I created a simple design which facilitates the purchasing experience.<br>Also, his comments on both Facebook and Twitter can be easily seen and users can check his latest social network activity.<br>His updated exciting gigs attract fans to come to his live shows.</p>
    ...
    <section class="page-sec">
        <div class="page-inner">
            ...
            <p class="inner-p">The music section shows his discography and provides some of his works. Users can enjoy his sample music on SoundCloud and can purchase his music on Amazon and iTunes</p>
    ...
    <section class="page-sec bg1 bg-b">
        <div class="page-inner">
            ...
            <p class="inner-p">Through researching some musician's websites, I noticed some of them had his original podcast channel. To give fans more of his thoughts and make deeper connections with them, I proposed that he make his own podcast channel and he loved the idea.<br> He shares some stories of gigs, recordings, and his life memories. He also interviews some featured musicians and plays some live gigs with them.</p>
